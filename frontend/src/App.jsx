        ...
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div onClick={() => handleNavigate('landing')} className="flex items-center gap-3 cursor-pointer">
            ...
            <div>
              ...
              <span className="text-[10px] text-sky-400 font-semibold uppercase tracking-wider">Multi-Industry AI Resume Studio</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className={`text-xs font-bold px-3 py-1.5 rounded-lg border transition flex items-center gap-1.5 ${currentView === 'templates' ? 'bg-sky-600/20 border-sky-500 text-sky-300' : 'bg-slate-900 border-slate-800 text-slate-300 hover:border-slate-700'}`}>
              <Palette className="w-3.5 h-3.5 text-sky-400" /> Templates ({dbTemplates.length})
            </button>
            ...
            <button 
              ...
              className={`text-xs font-bold px-3 py-1.5 rounded-lg border transition flex items-center gap-1.5 ${currentView === 'plans' ? 'bg-sky-600/20 border-sky-500 text-sky-300' : 'bg-slate-900 border-slate-800 text-sky-400 hover:border-sky-500'}`}>
